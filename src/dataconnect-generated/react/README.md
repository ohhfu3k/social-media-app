...
```javascript
useCreatePost(options?: useDataConnectMutationOptions<CreatePostData, FirebaseError, void>): UseDataConnectMutationResult<CreatePostData, undefined>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useCreatePost(dc: DataConnect, options?: useDataConnectMutationOptions<CreatePostData, FirebaseError, void>): UseDataConnectMutationResult<CreatePostData, undefined>;
```
...
```javascript
useFollowUser(options?: useDataConnectMutationOptions<FollowUserData, FirebaseError, FollowUserVariables>): UseDataConnectMutationResult<FollowUserData, FollowUserVariables>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useFollowUser(dc: DataConnect, options?: useDataConnectMutationOptions<FollowUserData, FirebaseError, FollowUserVariables>): UseDataConnectMutationResult<FollowUserData, FollowUserVariables>;
```
...
```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, FollowUserVariables } from '@dataconnect/generated';
...
export default function FollowUserComponent() {
  ...
  // After calling the Mutation hook function, you must call `UseMutationResult.mutate()` to execute the Mutation.
  // The `useFollowUser` Mutation requires an argument of type `FollowUserVariables`:
  const followUserVars: FollowUserVariables = {
    followingId: ..., 
  };
  mutation.mutate(followUserVars);
  ...
  mutation.mutate(followUserVars, options);
